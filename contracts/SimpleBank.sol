...
contract SimpleBank {
    ...
    /* create a getter function and allow contracts to be able to see if a user is enrolled.  */
    ...
    // transfer function
    /// @notice Transfer ether from bank to recipient
    /// @dev This does not return any excess ether sent to it
    /// @param recipient address to transfer ether to
